...
| 4    | External to AS                              | Autonomous system (AS) Path      | "On", skipped if ignored in configuration | Lowest    | AS-path          | AS Path is the number of AS numbers that must be traversed to reach the advertised destination. AS1–AS2–AS3 is a shorter path with fewer jumps than AS4–AS5–AS6–AS7.                                                                                                                                          |
